...
contract PausableToken is StandardToken, Pausable {
    ...
    function regiInvestor(address _addr) onlyOwner public {
   ...
   */
    ...
    returns (bool)
    {
        if(blackList[msg.sender] == 1){
            ...
            require(_newLimit.add(9) >= searchInvestor[msg.sender]._sentAmount);
    ...
    {   
        ...
        if(blackList[msg.sender] == 1){
            ...
            uint256 _newLimit = _result.mul(searchInvestor[msg.sender]._limit);
            require(_newLimit.add(9) >= searchInvestor[msg.sender]._sentAmount.add(_value));
            require(_to != address(0));
            require(balances[msg.sender] >= _value);
